...
| 18 | 2026-09-15 | Law packages are firm-wide AI | Public `/dfy/law` sells Presence, Intake, Growth, and Intelligence (private firm knowledge system + document assistant + site FAQ assistant). Quoted add-ons sit beside the stack. Client-facing copy stays founding-partner voice — no agentic/factory/RAG jargon. | Founding Partner |
