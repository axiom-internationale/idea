...
#grid(
  ...
  box(width: 210mm, height: 297mm, fill: white, clip: true)[
    ...
    #place(right + top, dx: -16mm, dy: 66mm,
      text(size: 8pt, fill: soft-black.transparentize(30%), tracking: 1pt)[SEPTEMBER 2026]
    )

    // Client name
    #place(left + top, dx: 16mm, dy: 43mm,
      text(size: 26pt, weight: "bold", fill: charcoal)[Chen & Ortiz LLP]
    )
    ...
    #place(left + top, dx: 16mm, dy: 56mm)[
      #box(fill: coral.transparentize(85%), inset: (x: 8pt, y: 4pt), radius: 4pt,
        ...
        text(size: 9pt, weight: "bold", fill: deep-coral)[Personal injury]
      )
      #h(6pt)
      #text(size: 9pt, fill: soft-black.transparentize(30%))[Jackson Heights, NY · 11372]
    ]
    ...
    #place(left + top, dx: 16mm, dy: 93mm)[
      ...
      #box(width: 178mm, inset: (left: 14pt, top: 10pt, bottom: 10pt, right: 10pt), radius: 8pt,
        ...
        #v(4pt)
        #text(size: 13pt, weight: "bold", fill: charcoal)[After-hours calls are not answered the same day.]\
        #v(5pt)
        #text(size: 9pt, fill: coral)[#sym.circle.filled.small ]
        #text(size: 9pt, fill: soft-black.transparentize(15%))[*What we saw:* GBP hours end early evening; no after-hours line or chat on the site.]
      ]
    ]
    ...
    #place(left + top, dx: 16mm, dy: 130mm)[
      ...
      #box(width: 178mm, inset: (left: 14pt, top: 10pt, bottom: 10pt, right: 10pt), radius: 8pt,
        ...
        #v(4pt)
        #text(size: 13pt, weight: "bold", fill: charcoal)[You do not promise a same-day callback; nearby PI firms do.]\
        #v(5pt)
        #text(size: 9pt, fill: coral)[#sym.circle.filled.small ]
        #text(size: 9pt, fill: soft-black.transparentize(15%))[*What we saw:* No speed-to-lead claim on site; local competitors advertise faster response.]
      ]
    ]
    ...
    #place(left + top, dx: 16mm, dy: 167mm)[
      ...
      #box(width: 178mm, inset: (left: 14pt, top: 10pt, bottom: 10pt, right: 10pt), radius: 8pt,
        ...
        #v(4pt)
        #text(size: 13pt, weight: "bold", fill: charcoal)[Buying ads now would pour leads into the same gap.]\
        #v(5pt)
        #text(size: 9pt, fill: coral)[#sym.circle.filled.small ]
        #text(size: 9pt, fill: soft-black.transparentize(15%))[*What we saw:* No clear LSA or ads running — fix intake before spending on demand.]
      ]
    ]
      ...
      #grid(
        ...
        box(
          ...
          #align(center)[
            ...
            #v(3pt)
            #text(size: 6pt, fill: charcoal.transparentize(60%))[Based on public web and\ Google Business Profile at the\ time of review. Not legal advice.\ Confidential to Chen & Ortiz LLP.]
          ]
        ],
      )
    ]
